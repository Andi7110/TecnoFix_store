...
class ReparacionResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'costos_total' => $this->whenLoaded('costos', fn (): float => round((float) $this->costos->sum('monto'), 2)),
            'utilidad_estimada' => $this->whenLoaded('costos', fn (): float => round((float) $this->costo_reparacion - (float) $this->costos->sum('monto'), 2)),
            ...
            'costos' => CostoReparacionResource::collection($this->whenLoaded('costos')),
